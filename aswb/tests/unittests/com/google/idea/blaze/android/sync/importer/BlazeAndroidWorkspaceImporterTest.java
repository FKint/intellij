                ...
                TargetIdeInfo.builder()
                    ...
                    .setAndroidAarInfo(
                        new AndroidAarIdeInfo(
                            source("third_party/lib/lib_aar.aar"), /*javaPackage=*/ null))
                    .setJavaInfo(
                        JavaIdeInfo.builder()
                            .addJar(
                                LibraryArtifact.builder()
        ...
        TargetMapBuilder.builder()
            ...
            .addTarget(
                TargetIdeInfo.builder()
                    ...
                    .setAndroidAarInfo(
                        new AndroidAarIdeInfo(
                            source("java/example/an_aar.aar"), /*javaPackage=*/ null))
                    .setJavaInfo(
                        JavaIdeInfo.builder()
                            .addJar(
                                LibraryArtifact.builder()
        ...
        TargetMapBuilder.builder()
            ...
            .addTarget(
                TargetIdeInfo.builder()
                    ...
                    .setAndroidAarInfo(
                        new AndroidAarIdeInfo(
                            source("third_party/lib/lib1_aar.aar"), /*javaPackage=*/ null))
                    .setJavaInfo(
                        JavaIdeInfo.builder()
                            .addJar(
                                LibraryArtifact.builder()
            ...
            .addTarget(
                TargetIdeInfo.builder()
                    ...
                    .setAndroidAarInfo(
                        new AndroidAarIdeInfo(
                            source("third_party/lib/lib2_aar.aar"), /*javaPackage=*/ null))
                    .setJavaInfo(
                        JavaIdeInfo.builder()
                            .addJar(
                                LibraryArtifact.builder()
